      ...
      <b-container fluid>
        <b-row class="text-center">
          ...
          <b-col cols="4" class="text-left">
            <div>
              <label class="label">Addition: {{ add }}</label>
            </div>
            <div>
              <label class="label">Multiplication: {{ mul }}</label>
            </div>
            <div>
              <label class="label">Subtraction: {{ sub }}</label>
            </div>
            <div>
              <label class="label">Division: {{ div }}</label>
            </div>
          </b-col>
        </b-row>
      </b-container>
